...
void InyectorControlAct_init(void)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
  UNITY_SET_DETAIL(CMockString_InyectorControlAct_init);
  CMOCK_InyectorControlAct_init_CALL_INSTANCE* cmock_call_instance = (CMOCK_InyectorControlAct_init_CALL_INSTANCE*)CMock_Guts_GetAddressFor(Mock.InyectorControlAct_init_CallInstance);
...
void InyectorControlAct_onIdleSpeed(Event* event)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
  UNITY_SET_DETAIL(CMockString_InyectorControlAct_onIdleSpeed);
  CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE* cmock_call_instance = (CMOCK_InyectorControlAct_onIdleSpeed_CALL_INSTANCE*)CMock_Guts_GetAddressFor(Mock.InyectorControlAct_onIdleSpeed_CallInstance);
...
void InyectorControlAct_onNormal(Event* event)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
  UNITY_SET_DETAIL(CMockString_InyectorControlAct_onNormal);
  CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE* cmock_call_instance = (CMOCK_InyectorControlAct_onNormal_CALL_INSTANCE*)CMock_Guts_GetAddressFor(Mock.InyectorControlAct_onNormal_CallInstance);
...
bool InyectorControlAct_isPressedThrottle(Event* event)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
  UNITY_SET_DETAIL(CMockString_InyectorControlAct_isPressedThrottle);
  CMOCK_InyectorControlAct_isPressedThrottle_CALL_INSTANCE* cmock_call_instance = (CMOCK_InyectorControlAct_isPressedThrottle_CALL_INSTANCE*)CMock_Guts_GetAddressFor(Mock.InyectorControlAct_isPressedThrottle_CallInstance);
...
bool InyectorControlAct_isReleasedThrottle(Event* event)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
  UNITY_SET_DETAIL(CMockString_InyectorControlAct_isReleasedThrottle);
  CMOCK_InyectorControlAct_isReleasedThrottle_CALL_INSTANCE* cmock_call_instance = (CMOCK_InyectorControlAct_isReleasedThrottle_CALL_INSTANCE*)CMock_Guts_GetAddressFor(Mock.InyectorControlAct_isReleasedThrottle_CallInstance);
...
void InyectorControlAct_starting(Event* event)
{
  UNITY_LINE_TYPE cmock_line = TEST_LINE_NUM;
  UNITY_SET_DETAIL(CMockString_InyectorControlAct_starting);
  CMOCK_InyectorControlAct_starting_CALL_INSTANCE* cmock_call_instance = (CMOCK_InyectorControlAct_starting_CALL_INSTANCE*)CMock_Guts_GetAddressFor(Mock.InyectorControlAct_starting_CallInstance);
